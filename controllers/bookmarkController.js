...
const addBookmark = async (req, res) => {
    ...
    const bookmarkedShows = await Movie.findOneAndUpdate({ _id: id }, {$push: {bookmarkBy: userId}});
...
const removeBookmark = async (req, res) => {
    ...
    const bookmarkedShows = await Movie.findOneAndUpdate({ _id: id }, { $pull: { bookmarkBy: userId }});
